...
const OrderModal = ({ showDetails, showEdit, toggleModal, order }: any) => {
  ...
  return (
    <>
      ...
      >
        <div className='shadow-7 relative w-full max-w-[600px] h-auto max-h-[90vh] scale-100 transform rounded-[15px] bg-white transition-all flex flex-col items-center'>
          <button
          ...
          <div className='w-full max-h-[85vh] overflow-y-auto rounded-[15px]'>
