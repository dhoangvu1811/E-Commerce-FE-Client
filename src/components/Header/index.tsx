                ...
                {isAuthenticated ? (
                  <div className='flex items-center gap-4'>
                    ...
                    >
                      ...
                      <div className='h-10 w-10 rounded-full overflow-hidden border border-gray-3'>
                        {user?.avatar ? (
                          <Image
                            src={user.avatar}
                            alt='User'
                          ...
                          <div className='w-full h-full bg-gray-2 flex items-center justify-center text-dark font-bold'>
                            {user?.name?.[0] || 'U'}
                          </div>
                        )}
                      </div>
                    ...
                    >
                      ...
                      >
                        ...
                        />
                        <path
                          d='M13 4V3C13 2.44772 13.4477 2 14 2H20C20.5523 2 21 2.44772 21 3V21C21 21.5523 20.5523 22 20 22H14C13.4477 22 13 21.5523 13 21V20'
                          stroke='currentColor'
                          strokeWidth='1.5'
                          strokeLinecap='round'
                          strokeLinejoin='round'
