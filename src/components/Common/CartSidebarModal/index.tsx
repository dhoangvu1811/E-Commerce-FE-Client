...
import { removeItemFromCart, selectTotalPrice } from '@/redux/slices/cartSlice'
...
const CartSidebarModal = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 z-99999 overflow-hidden w-full h-screen bg-dark/70 ease-linear duration-300 ${
        isCartModalOpen ? 'translate-x-0' : 'translate-x-full'
      }`}
    >
      <div className='flex items-center justify-end h-full'>
        <div className='w-full max-w-[500px] h-full flex flex-col shadow-1 bg-white px-4 sm:px-7.5 lg:px-11 relative modal-content'>
          <div className='flex-none bg-white flex items-center justify-between pb-7 pt-4 sm:pt-7.5 lg:pt-11 border-b border-gray-3 mb-7.5'>
          ...
          <div className='flex-none border-t border-gray-3 bg-white pt-5 pb-4 sm:pb-7.5 lg:pb-11 mt-7.5'>
