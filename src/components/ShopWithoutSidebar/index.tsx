              ...
              <div className='rounded-lg bg-white shadow-1 pl-3 pr-2.5 py-2.5 mb-6'>
                <div className='flex items-center justify-between'>
                  ...
                  <div className='flex flex-wrap items-center gap-4'>
                    {/* Replaced CustomSelect with native select or wire it up properly. 
                        Using native select for simplicity with React Hook Form or manually controlling CustomSelect.
                        Given CustomSelect implementation in ShopWithSidebar wasn't fully generic in prop usage earlier (it used specific logic), 
                        I'll use a standard select here like ShopWithSidebar did for sorting in previous view, OR reuse CustomSelect if it supports onChange.
                        Wait, ShopWithSidebar used register for sorting?
                        Use register with standard select for robust logic. */}
                    <select
                      {...register('sort')}
                      className='p-2 border rounded bg-white text-dark'
                    >
                      {options.map((opt) => (
